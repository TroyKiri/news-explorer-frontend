export class NewsCard {
  ...
  createArticleSaved() {
    const html = `<div class="article">
      <div class="article__info article__info_articles">
        <p class="article__keyword">${this.keyword}</p>
        <div class="article__icon article__icon_delete">
          <p class="article__message article__message_delete article__message_not-visible">Убрать из сохранённых</p>
        </div>
      </div>
      <img class="article__image" alt="image" src = ${this.image}>
      <a class = "article__link" href = ${this.link} target = "_blank">
